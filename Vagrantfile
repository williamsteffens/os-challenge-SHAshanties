Vagrant.configure("2") do |config|
  config.vm.define "server" do |server|
    ...
    server.vm.synced_folder "../os-challenge-SHAshanties/", "/home/vagrant/os-challenge-SHAshanties/"
  ...
  config.vm.define "client" do |client|
    ...
    client.vm.synced_folder "../os-challenge-SHAshanties/", "/home/vagrant/os-challenge-SHAshanties/"
